...
function SheetOverlay({ className, ...props }: SheetPrimitive.Backdrop.Props) {
  return (
    <SheetPrimitive.Backdrop
      ...
      // z-110: must clear the homepage-only nav's z-100 (home-navbar.tsx) —
      // otherwise it paints over the sheet's own header on that page.
      className={cn(
        "fixed inset-0 z-110 bg-black/50 duration-200 data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0",
        className
      )}
      {...props}
    />
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          "fixed z-120 flex flex-col gap-4 bg-background p-4 shadow-lg outline-none duration-200 data-open:animate-in data-closed:animate-out",
          SIDE_CLASSES[side],
          className
        )}
        {...props}
