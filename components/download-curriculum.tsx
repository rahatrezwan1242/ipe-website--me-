            ...
            >
              ...
              <span className="flex-1">
                ...
                <span className="block text-[11px] text-muted-foreground">
                  Opens a print-ready summary of all 8 semesters
                </span>
              </span>
            </a>
            <button
              ...
              className="flex w-full items-start gap-3 rounded-sm px-3 py-2 text-left transition-colors hover:bg-muted/60"
            >
