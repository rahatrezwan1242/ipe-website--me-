      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {REPS.map((rep, i) => (
            <div
              key={i}
              className="w-70 rounded-lg border px-6 py-8 text-center"
              style={{ background: HOME.bgCard, borderColor: HOME.border }}
            >
              <div
                className="mx-auto grid h-18 w-18 place-items-center rounded-full"
                style={{
                  background: `color-mix(in oklab, ${HOME.accentTeal} 20%, transparent)`,
                  border: `2px solid color-mix(in oklab, ${HOME.accentTeal} 40%, transparent)`,
                }}
              >
              ...
              <p
                ...
                style={{ fontFamily: "var(--font-figtree)", color: HOME.accentWarm }}
              >
                {rep.role}
              </p>
              <div className="mt-5 flex items-center justify-center gap-4">
                {[Link2, Phone, Mail].map((Icon, idx) => (
                  <span
                    ...
                    style={{ color: HOME.textMuted, opacity: 0.6 }}
                  >
